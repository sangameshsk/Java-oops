...
import com.pratick.thrilio.constants.Gender;
...
public class DataStore {
	...
	private static void loadUsers() {
		...
		users[4] = UserManager.getInstance().createUser(1004, "user4@semanticsquare.com", "test", "Pratick", "M",
	...
	private static void loadWebLinks() {
		...
		bookmarks[0][2] = BookmarkManager.getInstance().createWeblink(2000, "Interface vs Abstract Class",
				"http://mindprod.com/jgloss/interfacevsabstract.html", "http://mindprod.com");

		bookmarks[0][3] = BookmarkManager.getInstance().createWeblink(2000, "NIO tutorial by Greg Travis",
				"http://cs.brown.edu/courses/cs161/papers/j-nio-ltr.pdf", "http://cs.brown.edu");

		bookmarks[0][4] = BookmarkManager.getInstance().createWeblink(2000, "Virtual Hosting and Tomcat",
	...
	private static void loadBooks() {
		...
		bookmarks[2][2] = BookmarkManager.getInstance().createBook(4002, "Light From Many Lamps", 1988, "Touchstone",
				new String[] { "Lillian Eichler", "Watson	Philosophy" }, BookGenre.PHILOSOPHY, 5.0);
		...
		bookmarks[2][4] = BookmarkManager.getInstance().createBook(4004, "Effective Java Programming Language Guide",
				2007, "Wilder Publications", new String[] { "Prentice Hall", "TJoshua Bloch" }, BookGenre.TECHNICAL,
				4.9);
	}
