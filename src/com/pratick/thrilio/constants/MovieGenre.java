package com.pratick.thrilio.constants;
...
public class MovieGenre {
	...
	public static final String SCIFI_AND_FANTACY = "sci-fi & Fantasy";
	...
	public static final String INDIPENDENT = "Indipendent";
	...
	public static final String GAY_AND_LESEBIAN = "Gay & Lesbian";
	public static final String CLASSIC_MOVIE_MUSICALS = "Classic Movie Musicals";
	public static final String FAITH_AND_SPIRTUALITY = "Faith & Spirtuality";
